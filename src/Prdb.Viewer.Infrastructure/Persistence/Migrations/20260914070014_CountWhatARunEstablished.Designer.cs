...
namespace Prdb.Viewer.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260914070014_CountWhatARunEstablished")]
    partial class CountWhatARunEstablished
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prdb.Viewer.Infrastructure.Persistence.BackgroundWorkRow", b =>
                {
                    ...
                    b.Property<string>("PassedOverExtensionsJson")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Prdb.Viewer.Infrastructure.Persistence.IdentificationCandidateRow", b =>
                {
                    ...
                    b.Property<Guid?>("ProposedWorkId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Prdb.Viewer.Infrastructure.Persistence.PersonalActorStateRow", b =>
                {
                    ...
                    b.HasKey("AccountId", "PrdbActorId");

                    b.HasIndex("AccountId");

                    b.ToTable("personal_actor_state", (string)null);
                });
            ...
            modelBuilder.Entity("Prdb.Viewer.Infrastructure.Persistence.ProposedWorkRow", b =>
                {
                    ...
                    b.Property<string>("ArtworkContentType")
                        .HasColumnType("TEXT");

                    b.Property<string>("ArtworkRelativePath")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("ArtworkRetainedAt")
                        .HasColumnType("TEXT");

                    b.Property<string>("ArtworkState")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid?>("PublicArtworkId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ArtworkState");

                    b.HasIndex("PrdbVideoId")
                        .IsUnique();

                    b.HasIndex("PublicArtworkId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Prdb.Viewer.Infrastructure.Persistence.VideoImageRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("VideoId", "PrdbImageId")
                        .IsUnique();

                    b.ToTable("video_image", (string)null);
                });
            ...
            modelBuilder.Entity("Prdb.Viewer.Infrastructure.Persistence.VideoMetadataRow", b =>
                {
                    ...
                    b.Property<long?>("DurationSpreadMilliseconds")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("QualityOverviewJson")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("ReleaseDate")
                        .HasColumnType("TEXT");

                    b.Property<string>("ReleaseNamesJson")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Prdb.Viewer.Infrastructure.Persistence.VideoRow", b =>
                {
                    ...
                    b.Property<string>("NormalizedSite")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Prdb.Viewer.Infrastructure.Persistence.IdentificationCandidateRow", b =>
                {
                    b.HasOne("Prdb.Viewer.Infrastructure.Persistence.ProposedWorkRow", "ProposedWork")
                        .WithMany()
                        .HasForeignKey("ProposedWorkId")
